        ...
        columns:[
          ...
          {data:null,render:function(data){
            return `<button type="button" class="btn btn-primary btn-sm btn-editar" name="button" data-id="${data.id}"><i class="fa fa-edit"></i> </button>
              <button type="button" class="btn btn-dark btn-sm btn-cronograma" name="button" data-id="${data.id}" data-descripcion="${data.producto}"><i class="fas fa-calendar-alt"></i> </button>
